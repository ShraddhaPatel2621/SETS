		 ...
		 <!-- left column -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="AddExpense" action="InsertExpense.php" method="post" enctype="multipart/form-data">
...
<!--                         <div class="card-header">
                      ...
                      <div class="form-group">
                        <label for="Image">Image</label>
                          <input type="File" name="fileToUpload" id="fileToUpload" class="form-control" id="Image">
                      </div> 
                </div>
                <!-- /.card-body -->
