...
<head>
  ...
  <title>SETS | Edit Income Details</title>
		 ...
		 <!-- left column -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="UpdateAmbition" action="UpdateIncome.php" method="post"enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control" name="Income_Category" required>
                          ...
                          while($row = mysqli_fetch_assoc($resultNews)){  
                            echo '<option value="'.$row['Income_Category'].'">'.$row['Income_Category'].'</option>'; 
