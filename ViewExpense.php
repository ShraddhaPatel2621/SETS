  ...
  <div class="content-wrapper">
    ...
    // output data of each row
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<td><form action='EditExpense.php' Method='POST'><input type='hidden' name='Expense_Id' value='".$row['Expense_Id']."'>

                          <button type='submit' class='btn btn-primary btn-sm'>Edit</button></form></td>";

                          echo "<td><form action='DeleteExpense.php' Method='POST'><input type='hidden' name='Expense_Id' value='".$row['Expense_Id']."'>";
