...
<head>
  ...
  <title>SETS | Edit Budget Details</title>
...
$BudgetCat_Type = $row['BudgetCat_Type'];
		 ...
		 <!-- left column -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="UpdateBudget" action="UpdateBudget.php" method="post"enctype="multipart/form-data">
