...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['user'] == 'user'){
  ...
  <head>
    ...
    <title>SETS | Edit Expense Details</title>
...
// }
        ...
        $ExpenseCategory_Type = $row['ExpenseCategory_Type'];
        $Amount = $row['Amount'];
        $Date = $row['Date'];
            ...
            <div class="row">
             ...
             <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="UpdateExpense" action="UpdateExpense.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                       ...
                       <input type="date" name="Date" class="form-control" id="Date" placeholder="Select Date" value="<?php echo $Date; ?>" required>
                     </div>
                     <!-- Summernote -->
                     <label for="Date">Discription</label>
                     <div class="card card-outline card-info">
                      <div class="card-body">
                        <textarea id="summernote" name="summernote"><?php echo $Description; ?></textarea>
                      </div>
                    </div> 
...
<script>
      $(document).ready(function(){
        $(document).on('change', '#ExpenseCategory_Type', function(){
            ...
            if(ExpenseCategory_Type.length != 0){
                ...
                $('#Expense_Category').html('<option value=""> -- SELECT -- </option>');
            }
        });
    });
